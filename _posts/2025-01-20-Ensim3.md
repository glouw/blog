...
Directed Cyclic Graphs (DCG), when traversed breadth first, happen to model internal combustion fluid sim ordering. Seen below,
an inline 8 engine hypothetical exeuction with plenum intake left, and four exhaust system, ejecting to the atmosphere right, with a turbo
