...
Whole program performance across 3 threads averages ~1.7 instructions per cycle:

`perf stat` metrics on a laptop from 2019 using an `Intel(R) Core(TM) i7-8665U CPU @ 1.90GHz`:
