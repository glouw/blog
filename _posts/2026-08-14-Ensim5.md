...
and a ~15 instructions. A straight eight engine can compute its flow field in less than 100 instructions.
...
We are not limited to the above equations, however, so [see the implementation of ensim.cc](https://github.com/glouw/ensim5).
