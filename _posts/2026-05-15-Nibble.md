...
can chain and pass values down a correct precedence hierarchy:
...
```
_Note that lower precedence here means stronger-binding-power. Some define that as the other direction._
